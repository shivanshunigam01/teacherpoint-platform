...
export const Route = createFileRoute("/register")({
  component: Register,
  head: () => ({ meta: [{ title: "Create account · TeacherPoint" }, { name: "description", content: "Sign up free for TeacherPoint." }] }),
});
  ...
  return (
    <section className="container mx-auto px-4 py-12 max-w-md">
      <div className="bg-card border rounded-2xl p-8 shadow-soft">
        ...
        <form className="mt-6 space-y-4" onSubmit={(e) => { e.preventDefault(); login("student"); toast.success("Welcome to TeacherPoint!"); nav({ to: "/student" }); }}>
